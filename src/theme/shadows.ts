...
const LIGHT_MODE = palette.neutral[500];
...
const createCustomShadow = (color: string) => {
  ...
  return {
    ...
    primary: `0 8px 16px 0 ${alpha(palette.primary[900], 0.24)}`,
    info: `0 8px 16px 0 ${alpha(palette.info.main, 0.24)}`,
    success: `0 8px 16px 0 ${alpha(palette.success[900], 0.24)}`,
    secondary: `0 8px 16px 0 ${alpha(palette.success[900], 0.24)}`,
    warning: `0 8px 16px 0 ${alpha(palette.warning[900], 0.24)}`,
    error: `0 8px 16px 0 ${alpha(palette.error[900], 0.24)}`,
  };
};
