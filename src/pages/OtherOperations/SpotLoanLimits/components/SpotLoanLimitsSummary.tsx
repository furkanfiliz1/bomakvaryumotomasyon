...
import type { SpotLoanLimitsStats } from '../spot-loan-limits.types';

interface SpotLoanLimitsSummaryProps {
  stats: SpotLoanLimitsStats | null;
}

const SpotLoanLimitsSummary: React.FC<SpotLoanLimitsSummaryProps> = ({ stats }) => {
  const summaryCards = [
    {
...
export default SpotLoanLimitsSummary;
