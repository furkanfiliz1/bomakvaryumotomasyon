...
/**
 * Filter component for Lead Channel Consensus report
 * Following IntegratorConsensus pattern exactly - using Form component with React Hook Form
 */
...
interface LeadChannelConsensusFiltersProps {
...
export const LeadChannelConsensusFilters: React.FC<LeadChannelConsensusFiltersProps> = ({
  form,
  schema,
  onSearch,
  onReset,
